...
public interface ConnectionConfig {
  ...
  /**
   * Maximum amount of time that a client will wait for a response from the server after sending a
   * request. It measures the duration for which the client is willing to wait to receive data from
   * the server
   */
  @Default("60s")
