...
public @interface Stability {
     ...
     * <li>Has been introduced as part of a trial phase for the specific
     * feature.</li>
     * </ul>
     */
    @Documented
     ...
     *
     * <p>
     * It may be changed in incompatible ways and dropped from one release
    ...
    /**
     * A committed interface is the highest grade of stability, and is the preferred
     * attribute
     * level for consumers of the library.
     *
     * <p>
     * Couchbase tries at best effort to preserve committed interfaces between major
     * versions, and changes to committed interfaces within a major version
     * is highly exceptional. Such exceptions may include situations where the
     * interface
     * may lead to data corruption, security holes etc.
     * </p>
     *
     * <p>
     * Explicitly note that backwards-compatible extensions are always allowed since
     * they don't break old code.
     * </p>
     *
     * <p>
     * This is the default interface level for an API, unless the API is
     * specifically
     * marked otherwise.
     * </p>
     */
     ...
     *
     * <p>
     * Similar to volatile interfaces, no promises are made about these kinds of
     * interfaces and
     * they change or may vanish at every point in time. But in addition to that,
     * those interfaces
     * are explicitly marked as being designed for internal use and not for external
     * consumption
     * in the first place.
     * </p>
     *
